...
public class Test21 {
    ...
    public static void main(String[] args) {
        System.out.println(new Test21().solution1(new int[] {4, 3, 1, 2, 5}));
        System.out.println(new Test21().solution1(new int[] {5, 4, 3, 2, 1}));
    }
    ...
    public int solution1(int[] order) {
        ...
        for (int i = 1; i <= order.length; i++) {
            ...
            while (!support.isEmpty() && order[orderIndex] == support.peek()) {
                orderIndex++;
                answer++;
            }
        }
